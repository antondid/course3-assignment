...
setwd("~/Coursera courses/JHU/final/")
...
# reading the data
train_labels <- read.table("~/Coursera courses/JHU/final/train/y_train.txt")
train_full <- read.table("~/Coursera courses/JHU/final/train/X_train.txt")
train_sub <- read.table("~/Coursera courses/JHU/final/train/subject_train.txt")
...
test_labels <- read.table("~/Coursera courses/JHU/final/test/y_test.txt")
test_full <- read.table("~/Coursera courses/JHU/final/test/X_test.txt")
test_sub <- read.table("~/Coursera courses/JHU/final/test/subject_test.txt")
